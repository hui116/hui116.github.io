...
/////////////////////////////////////////////////////////////////////////////////////p[]
    ...
    .style("fill", function color(d) {
      ...
      if (0<d.id<7)
           result = "rgb(136,219,223)", NoStorke;
      // if (d.10<id<30) result = "rgb(164,219,232)", NoStorke;
      else if (7<d.id<10)
        result = "rgb(164,219,232)";
      else if (10<d.id<30)
          result ="rgb(113,176,180)";
...
CodeFlower.prototype.getById = function(id) {
  return d3.selectAll("circle").filter(c => {
    return c.id == id;
  }).pop();
};
